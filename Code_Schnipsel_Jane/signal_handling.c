...
int main() {
	...
	// Registriere den Signal-Handler fuer die Signale SIGUSR1 und SIGUSR2
	// Man kann nun den Signal-Handler ausloesen indem man "kill -USR1 <pid>" bzw. "kill -USR2 <pid>"
